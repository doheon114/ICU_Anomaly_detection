...
output_dir = '/home/work/.doheon114/ICU_Anomaly/pseudo_labels_one/images_rgb'
output_dir_aug = '/home/work/.doheon114/ICU_Anomaly/pseudo_labels_one/images_rgb_aug'
...
for file_path in png_files:
    ...
    if img is None:
        ...
        continue
    # RGB 이미지에 가우시안 노이즈 추가 (평균 0, 표준편차 0.01, 0~255 범위 유지)
    ...
    cv.imwrite(os.path.join(save_dir_aug, f"{name}.png"), noisy_img)
